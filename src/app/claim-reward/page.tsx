                    ...
                    <form onSubmit={handleClaimReward} className="space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-4 text-center text-2xl font-mono border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent tracking-widest"
                                maxLength={6}
                                required
                            />
